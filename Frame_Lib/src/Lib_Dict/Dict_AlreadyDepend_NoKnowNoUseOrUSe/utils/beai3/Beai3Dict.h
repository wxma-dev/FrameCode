...
/* int AT_ARRAY(DictHandle,int,DictHandle*) */
#define AT_ARRAY(handle,index,value) GetArrayDict(handle,index,value)
/* int ADD_ARRAY(DictHandle,DictHandle) */
#define ADD_ARRAY(handle,value) AddArrayDict(&(handle),value)
#endif
