 ...
 *  【新闻搜集系统】
 *  真实的ip:
 *  http://szb.farmer.com.cn/nmrb/html/2018-08/23/nw.D110000nmrb_20180823_2-01.htm?div=-1
 *
 *  解析获取：
 *  http://szb.farmer.com.cn/nmrb/html/2018-08/23/nw.D110000nmrb_20180823_${某版本的第几条新闻}-${版面序号}.htm?div=-1
 *
 *  使用boost库，来进行开发，不管是哪个平台都没有问题的。
 *
 *  新闻搜索
 */
class CReadNewspaper_NMRB: public CReadNewspaper
{
    public:
    ...
    public:
        ...
        */
        string Get_NextReading_NewspaperAdreess()
        {
            ...
            sprintf( sBuf_Tmp, 
                   "http://szb.farmer.com.cn/nmrb/html/%4.4d-%02.2d/%02.2d/nw.D110000nmrb_%4.4d%02.2d%02.2d_%d-%02.2d.htm?div=-1", 
        ...
        string Get_NextReading_File()
        {
            ...
            sprintf( sBuf_Tmp, 
                   "D110000nmrb_%4.4d%02.2d%02.2d_%d-%02.2d.html", 
                   oNewsPaper.iYear_Newspaper,  oNewsPaper.iMon_Newspaper, oNewsPaper.iDate_Newspaper,
                   this->iXh_Bm_Newspaper, this->iBm_Newspaper );
...
char * CReadNewspaper_NMRB::sPaper_Name = "农民日报" ;
