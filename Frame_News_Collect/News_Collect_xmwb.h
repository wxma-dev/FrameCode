 ...
 *  【新闻搜集系统】
 *  真实的ip:
 *  http://xmwb.xinmin.cn/html/2018-08/24/content_20_2.htm
 *
 *  解析获取：
 *  http://xmwb.xinmin.cn/html/2018-08/24/content_${版面序号}_${某版本的第几条新闻}.htm
 *
 *  使用boost库，来进行开发，不管是哪个平台都没有问题的。
 *
 *  新闻搜索
 */
class CReadNewspaper_XMWB: public CReadNewspaper
{
    public:
        ...
        void ReadNewsPaper()
        {
            ...
            while ( 1 )
            {
                ...
                else
                {
                    ...
                    else if ( -1 == iFlag_Data && 1 == iFlag_Title )
                    {
                        this->iBm_Newspaper++;
                        this->iXh_Bm_Newspaper = 1;
...
char * CReadNewspaper_XMWB::sPaper_Name = "新民晚报" ;
